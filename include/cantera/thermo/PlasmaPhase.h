 ...
 *   @f]
 * where @f$ i @f$ is the index of discrete energy levels.
 *
...
public:
    ...
    //! Return the value of #m_electronElectronEnergyLossCoefficients
    vector<double> elasticElectronEnergyLossCoefficients();
...
private:
    ...
    //! Use for storing interpolated cross sections temporarily
    vector<double> m_cs_interp;
